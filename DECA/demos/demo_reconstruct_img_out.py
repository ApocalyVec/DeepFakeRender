...
def main(args):
    ...
    for i in tqdm(range(len(testdata))):
        ...
        if args.saveVis:
            cv2.imwrite(os.path.join(savefolder, 'vis_' + name + '.jpg'), deca.visualize(visdict))
            cv2.imwrite(os.path.join(savefolder, 'detailed_images_' + name + '.jpg'), deca.visualize_detailed_image(visdict))
